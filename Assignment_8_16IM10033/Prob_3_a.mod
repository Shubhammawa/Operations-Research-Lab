 ...
 * OPL 12.8.0.0 Model
 * Author: Shubham Mawa
 * Creation Date: Mar 22, 2018 at 5:13:54 PM
 *********************************************/
 int nrep = 13;
 int nshift = 3;
...
/*
The additional constraint doesn't change the objective function value in this case but changes the distribution
of the individuals */